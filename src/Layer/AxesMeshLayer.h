#ifndef IQMOL_LAYER_AXESMESH_H
#define IQMOL_LAYER_AXESMESH_H
/*******************************************************************************
...
namespace Layer {
   ...
   /// orientation.
   class AxesMesh : public Global {

      Q_OBJECT

      friend class Configurator::AxesMesh;
      ...
      private:
         ...
         Configurator::AxesMesh m_configurator;
   };
