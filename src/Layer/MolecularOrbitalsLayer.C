   ...
   m_progressDialog(0)
{
   ...
   Data::Orbitals::OrbitalType type(m_molecularOrbitals.orbitalType());
   if (type == Data::Orbitals::Canonical ||
       type == Data::Orbitals::Localized) {
       computeDensityVectors();
   }

   m_availableDensities.append(m_molecularOrbitals.densityList());
...
void MolecularOrbitals::computeDensityVectors()
{
   ...
   m_availableDensities.append(new Data::Density(alpha, Pa));
   ...
   m_availableDensities.append(new Data::Density(beta, Pb));

   Data::SurfaceType total(Data::SurfaceType::TotalDensity);
   m_availableDensities.append(new Data::Density(total, Pa+Pb));

   Data::SurfaceType spin(Data::SurfaceType::SpinDensity);
   m_availableDensities.append(new Data::Density(spin, Pa-Pb));
}
...
void MolecularOrbitals::processSurfaceQueue()
{
   ...
   m_molecularGridEvaluator = new MolecularGridEvaluator(grids, shellList, 
      m_molecularOrbitals.alphaCoefficients(),
      m_molecularOrbitals.betaCoefficients(),
...
void MolecularOrbitals::gridEvaluatorCanceled()
{
   if (m_molecularGridEvaluator) {
...
void MolecularOrbitals::gridEvaluatorFinished()
{
...
void MolecularOrbitals::calculateSurfaces()
{
