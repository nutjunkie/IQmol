...
namespace Layer {
   ...
   class SurfaceAnimatorDialog : public QDialog {
      ...
      private Q_SLOTS:
         ...
         //void surfaceCalculationCancelled() { m_surfaceCalculationCancelled = true; }
      ...
      private:
         ...
         Layer::Surface* calculateSurface(Grid* grid, double const isovalue);
         ...
         bool m_surfaceCalculationCancelled;
   };
