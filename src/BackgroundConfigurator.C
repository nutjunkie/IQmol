   ...
   m_foregroundColor(m_background->m_foregroundColor)
{
   ...
   SetButtonColor(*(m_backgroundConfigurator.backgroundColorButton), m_backgroundColor);
   SetButtonColor(*(m_backgroundConfigurator.foregroundColorButton), m_foregroundColor);
}
