#ifndef IQMOL_SERVERQUEUE_H
#define IQMOL_SERVERQUEUE_H
/*******************************************************************************
...
namespace IQmol {
   ...
   class ServerQueue {
      ...
      public:
         friend class ServerQueueDialog;
         friend class PBSServer;
         friend class SGEServer;

         ServerQueue(QString const& name) : m_name(name),
   ...
   typedef QList<ServerQueue*> QueueList;
